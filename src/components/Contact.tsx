...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    .finally(() => {
      // Add inquiry to localStorage central store for instant local simulation
  ...
  return (
    <section id="contact" className="bg-[#f5f7fc] min-h-screen py-16 selection:bg-indigo-600 selection:text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch animate-fade-in delay-100">
          
          {/* Card 1: CONTACT SALES (Now on the Left) */}
          <div className="lg:col-span-5 bg-[#0f0e26] rounded-[2rem] p-6 sm:p-10 text-white border border-indigo-950/40 relative overflow-hidden shadow-2xl flex flex-col justify-between">
            <div>
              {/* Subtle Glow Overlay */}
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden relative p-6 sm:p-10 flex flex-col justify-between">
            <div>
